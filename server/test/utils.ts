...
import { UserAssetOverrideRepository } from 'src/repositories/user-asset-override.repository';
...
export type ServiceOverrides = {
  ...
  userAssetOverride: UserAssetOverrideRepository;
...
export const getMocks = () => {
  ...
  const mocks: ServiceMocks = {
    ...
    userAssetOverride: automock(UserAssetOverrideRepository),
...
export const newTestService = <T extends BaseService>(
  ...
  const sut = new Service(
    ...
    overrides.userAssetOverride || (mocks.userAssetOverride as As<UserAssetOverrideRepository>),
